...
export const account = {
  ...
  "registerForm.acceptPrefix": "I am 16 or older and I accept the",
  ...
  "verifyBanner.text": "Your email address isn't confirmed yet — check your inbox (and spam).",
  "verifyBanner.resend": "Resend the email",
  "verifyBanner.sent": "Email sent again. It's on its way.",
  "revoke.title": "Log out of all my devices",
  "revoke.body": "Closes every open session, everywhere — including this one. Do this if you fear one of your devices is compromised. You'll log back in afterwards.",
  "revoke.button": "Log out everywhere",
  ...
  "loginForm.codeHint": "This account is protected by two-factor authentication: enter the 6-digit code from your app, or one of your recovery codes.",
  ...
  "mfa.recoveryTitle": "Recovery codes — save them NOW",
  "mfa.recoveryBody": "Each of these codes lets you log in ONCE if you lose your phone. Write them on paper or in your password manager: they will never be shown again. Without them and without your phone, you won't be able to log in.",
