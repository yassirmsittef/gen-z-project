...
export const account = {
  ...
  "revoke.title": "Disconnetti tutti i miei dispositivi",
  "revoke.body": "Chiude tutte le sessioni aperte, ovunque — questa compresa. Fallo se temi che un tuo dispositivo sia compromesso. Poi accedi di nuovo.",
  "revoke.button": "Disconnetti ovunque",
