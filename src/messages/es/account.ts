...
export const account = {
  ...
  "registerForm.acceptPrefix": "Tengo 16 años o más y acepto las",
  ...
  "revoke.title": "Cerrar sesión en todos mis dispositivos",
  "revoke.body": "Cierra todas tus sesiones abiertas, en todas partes — incluida esta. Hazlo si temes que uno de tus dispositivos esté comprometido. Después vuelves a iniciar sesión.",
  "revoke.button": "Cerrar en todas partes",
