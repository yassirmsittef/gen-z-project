...
export const es = {
  ...
  common: {
    ...
    "support.surplus": "Nuestra línea de conducta: lo que supere las necesidades de la plataforma irá a apoyar los proyectos de otros miembros — lo diremos aquí, con cifras. No es un compromiso cuantificado.",
