...
export const account = {
  ...
  "revoke.title": "Von allen Geräten abmelden",
  "revoke.body": "Schließt alle offenen Sitzungen, überall — auch diese. Tu das, wenn du fürchtest, dass eines deiner Geräte kompromittiert ist. Danach meldest du dich neu an.",
  "revoke.button": "Überall abmelden",
