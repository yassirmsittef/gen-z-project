...
export const projectsPages = {
  ...
  "detail.ownerNotReadyOwner": "Um Beiträge zu erhalten, aktiviere zuerst deine Auszahlungen: das Geld deiner Unterstützer geht direkt auf dein Stripe-Konto, treuhänderisch, und braucht ein Ziel.",
  "detail.ownerNotReadyCta": "Auszahlungen aktivieren",
  "detail.ownerNotReadyVisitor": "Diese·r Projektträger·in hat den Empfang von Geldern noch nicht aktiviert: Beiträge sind derzeit nicht möglich.",
