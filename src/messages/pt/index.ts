...
export const pt = {
  ...
  common: {
    ...
    "support.surplus": "A nossa linha de conduta: o que exceder as necessidades da plataforma vai apoiar os projetos dos outros membros — diremos aqui, com números. Não é um compromisso quantificado.",
