...
export const account = {
  ...
  "registerForm.acceptPrefix": "Tenho 16 anos ou mais e aceito as",
  ...
  "revoke.title": "Terminar sessão em todos os meus dispositivos",
  "revoke.body": "Fecha todas as sessões abertas, em todo o lado — incluindo esta. Faz isto se receias que um dos teus dispositivos esteja comprometido. Depois inicias sessão de novo.",
  "revoke.button": "Terminar em todo o lado",
