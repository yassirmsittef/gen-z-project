...
export const account = {
  ...
  "revoke.title": "تسجيل الخروج من كل أجهزتي",
  "revoke.body": "يغلق كل الجلسات المفتوحة في كل مكان — بما فيها هذه. افعل ذلك إن خشيت أن أحد أجهزتك مخترق. ثم تسجّل الدخول من جديد.",
  "revoke.button": "الخروج من كل مكان",
  ...
  "loginForm.codeLabel": "رمز التحقق",
  "loginForm.codeHint": "هذا الحساب محمي بالمصادقة الثنائية: أدخل الرمز المكوّن من 6 أرقام من تطبيقك، أو أحد رموز الاسترداد.",
  "mfa.title": "المصادقة الثنائية",
  "mfa.body": "سيُطلب عند كل تسجيل دخول، إضافة إلى كلمة المرور، رمز لمرة واحدة يولّده تطبيق (Aegis أو Google Authenticator أو 1Password…).",
  "mfa.enable": "تفعيل",
  "mfa.secretLabel": "المفتاح الذي تُدخله في التطبيق",
  "mfa.uriLabel": "أو الصق هذا الرابط في التطبيق",
  "mfa.confirmLabel": "الرمز الظاهر في التطبيق",
  "mfa.confirm": "تأكيد وتفعيل",
  "mfa.enabledSince": "مفعّلة منذ {date}.",
  "mfa.disable": "إلغاء التفعيل",
  "mfa.disableHint": "تُطلب كلمة مرورك لإلغاء التفعيل.",
  "mfa.recoveryTitle": "رموز الاسترداد — احفظها الآن",
  "mfa.recoveryBody": "كل رمز من هذه يتيح لك الدخول مرة واحدة إذا فقدت هاتفك. اكتبها على ورق أو في مدير كلمات المرور: لن تُعرض مرة أخرى أبدًا. بدونها وبدون هاتفك لن تستطيع تسجيل الدخول.",
  "mfa.success": "تم تفعيل المصادقة الثنائية.",
  "mfa.disabled": "تم إلغاء تفعيل المصادقة الثنائية.",
