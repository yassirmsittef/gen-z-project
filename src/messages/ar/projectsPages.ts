...
export const projectsPages = {
  ...
  "detail.ownerNotReadyOwner": "لتلقّي المساهمات، فعّل أولًا مدفوعاتك: أموال مساهميك تصل مباشرة إلى حسابك على Stripe، في عهدة، وتحتاج إلى وجهة.",
  "detail.ownerNotReadyCta": "تفعيل مدفوعاتي",
  "detail.ownerNotReadyVisitor": "لم يفعّل صاحب المشروع استقبال الأموال بعد: لا يمكن المساهمة حاليًا.",
  "detail.edit": "تعديل",
