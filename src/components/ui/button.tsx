...
// `transition` (jeu de propriétés par défaut : couleurs, ombre, transform,
// opacité) plutôt que `transition-all`, qui animerait aussi les propriétés
// de layout.
const lift = "hover:-translate-y-0.5 transition duration-200 ease-out";
